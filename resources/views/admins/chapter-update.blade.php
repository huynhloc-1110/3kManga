...
<div class="row">
    <div class="col-md-12">
        ...
        <p>Please fill this form and submit to update the chapter in the database.</p>
        <form action="{{ url("adchapter-update-$chapter->id") }}" method="post" enctype="multipart/form-data">
            @csrf
            <!-- Manga Name -->
